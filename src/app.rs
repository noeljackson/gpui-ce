...
impl Application {
    ...
    /// Invokes a handler when the application becomes active (e.g. via Cmd+Tab).
    /// On macOS, this corresponds to `applicationDidBecomeActive:`.
